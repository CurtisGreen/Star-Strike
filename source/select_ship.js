var game = new Phaser.Game(1280, 700, Phaser.AUTO, 'select_ship', {
    preload: preload,
    create: create,
    update: update,
});
...
function create() {
    ...
    up_button = game.add.button(
        game.world.centerX - 503,
        100,
        'up',
        actionOnClickUp,
        this,
    ...
    resume_button = game.add.button(
        game.world.centerX - 530,
        150,
        'resume',
        actionOnClickResume,
        this,
